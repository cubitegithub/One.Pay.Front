...
using One.Site.Models.Certsolicitudtipo; 
...
namespace One.Site.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class CertsolicitudtipoController : ControllerBase
    {
        private readonly ILogger<CertsolicitudtipoController> _logger;
        private readonly IApiConsumo _apiConsumo;
        public CertsolicitudtipoController(ILogger<CertsolicitudtipoController> logger, IApiConsumo apiConsumo)
        {
            _logger = logger;
        ...
        [ActionFilterToken]
        [HttpPost("GetAll")]
        public ActionResult<List<CertsolicitudtipoOutputType>> Post()
        {
             
            string methodUrl = $"Certsolicitudtipo/GetAll";
            ...
            try
            {
                ...
                var resultObj = JsonSerializer.Deserialize<List<CertsolicitudtipoOutputType>>(resultTestObj);
 ...
 [ActionFilterToken]
   ...
   public ActionResult<List<CertsolicitudtipoOutputType>> PostSelectValue()
   {
       string methodUrl = $"Certsolicitudtipo/GetAll";
       ...
       catch (Exception exc)
       {
        ...
        {
            string methodUrl = $"Certsolicitudtipo/Delete/" + id;
        ...
        [ActionFilterToken]
        [HttpPost("Create")]
        public ActionResult<string> Create([FromBody] CertsolicitudtipoCreateIn modelIn)
        {

            string methodUrl = $"Certsolicitudtipo/Create";
            modelIn.Uidcertsolicitudtipo = Guid.NewGuid().ToString();
            try
            {
                ObjectResult? objectResult = null;
                string token = this.HttpContext.GetTokenContextSession(this, out objectResult);
        ...
        [ActionFilterToken]
        [HttpPost("GetById/{*id}")]
        public ActionResult<CertsolicitudtipoOutputType> GetById([FromRoute] string id)
        {
            string methodUrl = $"Certsolicitudtipo/GetById/" + id;
            ...
            try
            {
                ...
                var resultObj = JsonSerializer.Deserialize<CertsolicitudtipoOutputType>(resultTestObj);
        ...
        [ActionFilterToken]
        [HttpPut("Modify")]
        public ActionResult<string> Modify([FromBody] CertsolicitudtipoUpdateIn modelout)
        {
            string methodUrl = $"Certsolicitudtipo/Modify";
